...
typedef NS_ENUM(NSInteger, LiveError) {
    LiveErrorCreateLiveBroadCast,
    LiveErrorCreateStreamingChannel,
    LiveErrorBind,
    LiveErrorCheckoutLiveBroadCastStatus,
    LiveErrorTransitionLiveBroadCastStatus_1,
    LiveErrorTransitionLiveBroadCastStatus_2,
    LiveErrorGetLiveBroadcastStauts,
};
...
@property(nonatomic) UITextField *liveDurationField;
@property(nonatomic) UITextField *livePostTimeoutIntervalField;
